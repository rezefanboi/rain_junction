    ...
    collectVisible(minX, maxX) {
        ...
        for (let i = first; i <= last; i++) {
            ...
            for (const o of c.objects)
                objects.push(Object.assign(Object.assign({}, o), { worldX: base + o.localX }));
            for (const p of c.puddles)
                puddles.push(Object.assign(Object.assign({}, p), { worldX: base + p.localX, _src: p }));
            if (c.ambient)
                ambientEvents.push(Object.assign(Object.assign({}, c.ambient), { worldX: base + c.ambient.localX, chunkIndex: i }));
        }
